        ...
        <nav class="navbar navbar-expand navbar-dark bg-dark">
          <div class="container-fluid">
            <div class="navbar-header">
              <span class="navbar-brand">すみぺいんとぴーだぶりゅーえー</span>
            </div>
            <div class="navbar-collapse">
              <ul class="navbar-nav mr-auto">
                <b-dropdown
                  ...
                  >
                  <b-dropdown-item
                    @click="dropDownButtonClick('canvas-size-default')"
                    >
                    キャンバスサイズ変更(デフォルト)
                  </b-dropdown-item>
                  <b-dropdown-item
                    @click="dropDownButtonClick('canvas-size-vertical')"
                    >
                    キャンバスサイズ変更(縦長)
                  </b-dropdown-item>
                  <b-dropdown-item
                    @click="dropDownButtonClick('canvas-all-clear')"
                    >
                    全消し
                  </b-dropdown-item>
                </b-dropdown>
